 ...
 *
 * Tovarning 30 kunlik sotuvi shu turkumdagi boshqa tovarlar bilan
 * solishtiriladi. Mutlaq son emas, PERSENTIL: "100 dona" bir turkumda
 * koʻp, boshqasida hech narsa.
 *
 * Oʻlchov kuni yetarli boʻlmasa `null`. Sotuv stok farqidan chiqadi va
 * bitta nuqtadan farq chiqmaydi.
 */
export function talab(
  ...
  if (sotuv30k === null || olchanganKun === null) return null;
