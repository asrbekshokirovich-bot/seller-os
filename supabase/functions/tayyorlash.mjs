...
export const FAYLLAR = [
  ...
  ['packages/shared/src/filtrlar/nakrutka.ts', 'shared/filtrlar/nakrutka.ts'],
  ['packages/shared/src/filtrlar/ogir.ts', 'shared/filtrlar/ogir.ts'],
  ['packages/shared/src/filtrlar/mavsum.ts', 'shared/filtrlar/mavsum.ts'],
  ['packages/shared/src/filtrlar/hype.ts', 'shared/filtrlar/hype.ts'],
  ...
  ['packages/shared/src/xitoy.ts', 'shared/xitoy.ts'],
